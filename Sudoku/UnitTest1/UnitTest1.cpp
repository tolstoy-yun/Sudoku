...
namespace UnitTest1
{
	...
	public:
		...
		TEST_METHOD(TestMethod4){
			int a = get_file_size("C:\\Users\\HP\\source\\repos\\Sudoku\\Sudoku\\UnitTest\\t_get_file_size.txt");
		...
		TEST_METHOD(TestMethod5) {
			...
			test[5] = '\0';
			SudokuGame test_5;
			test_5.write_game("C:\\Users\\HP\\source\\repos\\Sudoku\\Sudoku\\UnitTest\\t_write_game.txt", test);
			fstream f;
			f.open("C:\\Users\\HP\\source\\repos\\Sudoku\\Sudoku\\UnitTest\\t_write_game.txt");
			char compare[6];
			for (int i = 0; i < 5; i++) {
				f >> compare[i];
			}
		...
		TEST_METHOD(TestMethod6) {
			...
			sudoku_array = test_6.read_game("C:\\Users\\HP\\source\\repos\\Sudoku\\Sudoku\\UnitTest\\t_read_game.txt", 0);
			char result_model[9][9] = {
	            {'1','6','$','$','$','9','$','8','4'},
	            {'7','2','$','3','$','$','$','$','$'},
	            {'3','8','$','$','$','$','7','2','9'},
		...
		TEST_METHOD(TestMethod14) {
			SudokuGame test_14;
			test_14.solute_sudoku("C:\\Users\\HP\\source\\repos\\Sudoku\\Sudoku\\UnitTest\\t_solute_sudoku.txt");
			Assert::IsTrue(test_14.sign_D);
		}
		//测试generate_only_game()
		TEST_METHOD(TestMethod15) {
			SudokuGame test_15;
			test_15.generate_endgame(15);
